...
#### Variables ####
readonly HTML_FILE='./example_manual/ABC_training_course_manual.html'
readonly COURSE_ID='1'
readonly ATTACHMENT_DIR='./example_manual/files'
readonly COURSE_MANAGER_SUBDOMAIN="customerxyz"
...
UpdateManualDraft() {
  ...
  if [[ $HTTPCode != "202" ]]; then
    ...
    echo "Unexpected response when trying to update the manual draft"
    exit 1
  fi
}
